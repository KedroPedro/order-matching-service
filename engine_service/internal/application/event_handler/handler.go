...
type EventHandler struct {
	eventCh    <-chan *entity.EventBatch
...
func NewEventHandler(eventCh chan *entity.EventBatch, marketRepo interfaces.MarketStateRepository, orderRepo interfaces.OrderRepository) *EventHandler {
	return &EventHandler{
		eventCh:    eventCh,
